...
BASE_SECTION = Section(
    ...
    (
        Category(
            ...
            package_text("base", "base-devel", "linux", "linux-firmware", "grub", "efibootmgr", "sudo", "git", "curl", "wget", "jq", "nano", "unzip", "7zip", "tree", "dosfstools", "exfatprogs", "zram-generator"),
...
SOFTWARE_SECTION = Section(
    ...
    (
        ...
        Category("node_tools", "Node.js LTS", "Node.js LTS actual de Arch y gestores JS", package_text("nodejs-lts-krypton", "npm", "pnpm", "yarn"), internal_runner=install_pacman_packages("Node.js LTS", ["nodejs-lts-krypton", "npm", "pnpm", "yarn"])),
        Category("python_tools", "Python tools", "Python, pip, uv, pipx y provider pynvim", package_text("python", "python-pip", "uv", "python-pynvim", "pipx"), internal_runner=install_pacman_packages("Python tools", ["python", "python-pip", "uv", "python-pynvim", "pipx"])),
        ...
        Category("go_rust_tools", "Go / Rust tools", "Go y Rust toolchain vía rustup", package_text("go", "rustup"), internal_runner=install_pacman_packages("Go / Rust tools", ["go", "rustup"])),
